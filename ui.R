...
ui = dashboardPage(
    dashboardHeader(title = "iTIME Enhanced"),
    dashboardSidebar(
        sidebarMenu(
    ...
    dashboardBody(
        ...
        tabItems(
            tabItem(tabName = 'import',
                    h1("iTIME Enhanced", align="center"),
                    fluidRow(
                        box(width = 12, status = "primary",
                            fluidRow(
                                ...
                                column(width = 4,
                                      ...
                                      # MJ added new code to support multiple spatial file uploads
                                       fileInput("spatialData", "Upload One or More Spatial Data Files (CSV Format)",
                                                 multiple = TRUE,
                                                 accept = c("csv",
                                                            "HALO summary data file",
                                                            c(".csv"))),    
                                      helpText("Ensure the file contains 'XMin', 'XMax', 'YMin', 'YMax' columns, and at least one valid marker column (e.g., CD3, CD8, PD1).")
                        ...
                        box(width = 12, status = 'primary', title = textOutput("selectedModelName"),
                            column(width = 4,
                                   column(width = 12, 
                                          ...
                                          selectInput("clinicalClass", "Select Clinical Variable Class",
            ...
            tabItem(tabName = 'spatial',
                    ...
                    box(width = 12, status = "primary",
                        ...
                        HTML('<footer>
                         In cases of large holes or uneven cell distributions, the theoretical estimate of complete spatial randomness (CSR) may be an inaccurate measure.
                         </footer>')
                    ),
